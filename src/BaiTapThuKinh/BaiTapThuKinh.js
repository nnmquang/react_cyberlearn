...
export default class BaiTapThuKinh extends Component {
    ...
    renderGlassesList = () => {
        return dataGlasses.map((glassesItem, index) => {
            return <img onClick={() => { this.changeGlasses(glassesItem) }} className="ml-2 p-2 border border-with-1" 
            style={{ width: '110px', cursor: 'pointer' }} key={index} src={glassesItem.url} alt='glassesItem.url' />
        })
    }
                        ...
                        <div className='row mt-5 text-center'>
                            <div className='col-6'>
                                <div className="position-relative">
                                    ...
                                    <img style={styleGlasses} className="position-absolute glassesStyle" src={this.state.glassesCurrent.url} alt='v1.png' />
