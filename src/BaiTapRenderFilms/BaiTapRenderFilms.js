...
export default class BaiTapRenderFilms extends Component {
            ...
            return <div className='col-3 mt-2' key={index}>
                <div className="card text-white bg-dark ml-5" style={{width: '250px'}}>
                    ...
                    <div className="card-body">
                        ...
                        <p className="card-text" style={{fontSize:'13px', height:'50px'}}>{film.moTa.length > 80 ? <p>
    ...
    render() {
        return (
            <div style={{ backgroundImage: 'url(./background/avenger.jpg)', minHeight: '2000px' }}>
                <div style={{ backgroundColor: 'rgba(0, 0, 0, .5)', minHeight: '2000px' }}>
                    <nav className="navbar navbar-expand-sm navbar-dark" style={{ backgroundColor: 'rgba(87,83,149,0.5)' }}>
